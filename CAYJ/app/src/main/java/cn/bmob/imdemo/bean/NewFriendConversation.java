...
public class NewFriendConversation extends Conversation{
    ...
    public String getLastMessageContent() {
        if(lastFriend!=null){
            ...
            //目前的好友请求都是别人发给我的
            if(status==null || status== Config.STATUS_VERIFY_NONE||
                    status ==Config.STATUS_VERIFY_READED){
                return name+"请求添加好友";
            }else{
                return "我已添加"+name;
            }
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(
                BmobIMApplication.INSTANCE()).getNewInvitationCount();
    }
