...
public class AddPetsMaintainDynamic extends ParentWithNaviActivity {
...
/*        View view = LinearLayout.inflate(AddDynamic.this, R.layout.add_dynamic_itme, null);
    ...
    private void upload() {
        ...
        dynamic = new PetsMaintainDynamic();

        dynamic.setValue(value+"");
        dynamic.setPassvalue(passvalue+"");
        ...
        dynamic.save(getApplicationContext(),new SaveListener(){
            ...
            public void onSuccess() {
                Toast.makeText(AddPetsMaintainDynamic.this, "上传成功", Toast.LENGTH_SHORT).show();
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(AddPetsMaintainDynamic.this, "上传失败", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void upload(String imgpath) {
        ...
        icon.upload(AddPetsMaintainDynamic.this, new UploadFileListener() {
            @Override
            public void onSuccess() {
                ...
                dynamicImageAlong.save(getApplicationContext(), new SaveListener() {
                    ...
                    @Override
                    public void onSuccess() {
                        Toast.makeText(AddPetsMaintainDynamic.this, "图片上传成功", Toast.LENGTH_SHORT).show();
                    ...
                    @Override
                    public void onFailure(int i, String s) {
                        Toast.makeText(AddPetsMaintainDynamic.this, "图片上传shibai1" + s.toString(), Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(AddPetsMaintainDynamic.this, "图片上传shibai2", Toast.LENGTH_SHORT).show();
