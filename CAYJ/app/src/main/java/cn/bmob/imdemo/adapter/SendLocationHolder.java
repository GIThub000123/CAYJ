...
public class SendLocationHolder extends BaseViewHolder {
  ...
  public SendLocationHolder(Context context, ViewGroup root,BmobIMConversation c,
  ...
  public void bindData(Object o) {
    ...
    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,info != null ? info.getAvatar() : null,
            R.mipmap.head);
