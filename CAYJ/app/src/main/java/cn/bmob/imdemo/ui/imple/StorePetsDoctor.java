...
public class StorePetsDoctor extends BaseImple{
    ...
    public StorePetsDoctor(Activity activity) {
        mActivity = activity;
        ...
        storeFoodsListBean.setAvatar(R.drawable.icon_head1);
        storeFoodsListBean.setTime("2017-3-28 15:30");
        storeFoodsListBean.setContent("医务！");
        storeFoodsListBean.setContentImages(R.mipmap.ic_doctor1);
        ...
        storeFoodsListBean.setTime("2017-3-28 15:30");
        storeFoodsListBean.setContent("医务！");
        storeFoodsListBean.setContentImages(R.mipmap.ic_doctor2);
        storeFoodsListBean.setGood("520");
        storeFoodsListBean.setTranslate("52");
        listStoreFoodsBean.add(storeFoodsListBean);
        ///
        ...
        storeFoodsListBean.setTime("2017-3-28 15:30");
        storeFoodsListBean.setContent("医务！");
        storeFoodsListBean.setContentImages(R.mipmap.ic_doctor3);
        storeFoodsListBean.setGood("520");
        storeFoodsListBean.setTranslate("52");
        listStoreFoodsBean.add(storeFoodsListBean);
        //////
