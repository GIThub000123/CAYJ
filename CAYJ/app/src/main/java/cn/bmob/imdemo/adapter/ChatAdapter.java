...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    //SendTextHolder(R.layout.X，parent,false);
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_SEND_TXT) {
            ...
            return new ReceiveLocationHolder(parent.getContext(), parent,c,onRecyclerViewListener);
        } else if (viewType == TYPE_RECEIVER_VOICE) {
            return new ReceiveVoiceHolder(parent.getContext(), parent,c,onRecyclerViewListener);
            ...
            return new ReceiveVideoHolder(parent.getContext(), parent,c,onRecyclerViewListener);
    ...
    //bindHolder(itemList.get（position））；
    @Override
    ...
    //获取信息的样式，发送，接收，，文字，图片，位置，，，，，
    //itemList.get(position).type
    @Override
