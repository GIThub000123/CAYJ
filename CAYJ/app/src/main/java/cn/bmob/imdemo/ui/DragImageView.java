 ...
 * onLayout方法：是一个回调方法.该方法会在在View中的layout方法中执行，
 * 在执行layout方法前面会首先执行setFrame方法.
 * layout方法：
 * * setFrame方法：判断我们的View是否发生变化，如果发生变化，
 * 那么将最新的l，t，r，b传递给View，然后刷新进行动态更新UI.
...
public class DragImageView extends ImageView {
    ...
    class MyAsyncTask extends AsyncTask<Void, Integer, Void> {
        ...
        public MyAsyncTask(int screen_W, int current_Width, int current_Height) {
            ...
            scale_WH = (float) this.current_Height / this.current_Width;
            step_H = STEP;
