...
import cn.bmob.imdemo.ui.DragImageActivity;
...
public class SendImageHolder extends BaseViewHolder {
  ...
  public SendImageHolder(Context context, ViewGroup root,BmobIMConversation c,
    ...
    iv_picture.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if(TextUtils.isEmpty(message.getRemoteUrl())){
          avatar = message.getLocalPath();
        } else {
          avatar = message.getRemoteUrl();
        }
        bundle.putString("avatar",avatar);
        startActivity(DragImageActivity.class,bundle);
