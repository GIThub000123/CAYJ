...
public class SendTextHolder extends BaseViewHolder
  ...
  public void bindData(Object o) {
    ...
    final BmobIMUserInfo info = message.getBmobIMUserInfo();   //有时有，有时无空
    final String userAvatar = UserModel.getInstance().getCurrentUser().getAvatar();
    //ImageLoaderFactory为自己写的ImageLoader框架
    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,userAvatar != null ? userAvatar : null, R.mipmap.head);
