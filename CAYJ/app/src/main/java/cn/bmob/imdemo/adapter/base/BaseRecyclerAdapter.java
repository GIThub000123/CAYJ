...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    protected List<T> lists;     //数据来源
    protected IMutlipleItem<T> items;  //获取内容项，点开看
    protected OnRecyclerViewListener listener;       //传递点击事件
